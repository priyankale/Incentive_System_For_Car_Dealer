...
class ListCompanyCarComponent extends Component {
    constructor(props) {
        super(props)
    ...
    viewCar(id) {
        this.props.history.push(`/view-ccar/${id}`);
    }
    editCar(id) {
    ...
    addCar() {
        window.location.href = '/add-ccar/_add'
    }
    viewIncentive(id) {
        this.props.history.push(`/view-ccar/${id - 1}`);
    }
...
export default ListCompanyCarComponent